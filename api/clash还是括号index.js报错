  ...
  try {
    ...
    if (isClash) {
      ...
      for (let i = 0; i < randomizedIPs.length; i++) {
        ...
        proxyNames.push(`    - "${nodeName}"`); // 注意这里的格式保持对齐
